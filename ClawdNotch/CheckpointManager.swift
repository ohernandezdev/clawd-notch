...
class CheckpointManager {
    ...
    private let refPrefix = "refs/clawd-snapshots"
    ...
    func createCheckpoint(projectName: String, projectDirectory: String) throws {
        ...
        let tempIndex = NSTemporaryDirectory() + "ClawdNotch-index-\(UUID().uuidString)"
        ...
        let commit = try git(["commit-tree", tree, "-m", "Clawd checkpoint \(timestamp)"], in: projectDirectory)
