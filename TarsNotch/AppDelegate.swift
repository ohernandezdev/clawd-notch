...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        // Auto-open panel on permission requests
        NotificationCenter.default.addObserver(forName: .TarsPermissionRequest, object: nil, queue: .main) { [weak self] _ in
    ...
    private func setupStatusItem() {
        ...
        if let button = statusItem.button {
            button.image = NSImage(named: "menuIcon") //NSImage(systemSymbolName: "terminal", accessibilityDescription: "TarsNotch")
...
//        menu.addItem(.separator())
    ...
    @objc private func showAbout() {
        ...
        github.com/ohernandezdev/tars-notch
        """
        ...
        if response == .alertFirstButtonReturn {
            NSWorkspace.shared.open(URL(string: "https://github.com/ohernandezdev/tars-notch")!)
        }
    }
